...
const _runTestsForDescribeBlock = async (describeBlock, rng, isRootBlock = false) => {
  ...
  // eslint-disable-next-line no-restricted-globals
  global[_types.RETRY_IMMEDIATELY] || false;
      ...
      case 'test':
        {
          ...
          if (retryImmediately && hasErrorsBeforeTestRun === false && hasRetryTimes) {
            await rerunTest(child);
          }
          if (hasErrorsBeforeTestRun === false && hasRetryTimes && !retryImmediately) {
...
exports.WAIT_BEFORE_RETRY = exports.TEST_TIMEOUT_SYMBOL = exports.STATE_SYM = exports.RETRY_TIMES = exports.RETRY_IMMEDIATELY = exports.LOG_ERRORS_BEFORE_RETRY = void 0;
var Symbol = globalThis['jest-symbol-do-not-touch'] || globalThis.Symbol;
/**
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 *
